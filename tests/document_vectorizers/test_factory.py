...
def test_create_all_minilm_document_vectorizer(mocker: MockerFixture) -> None:
    ...
    actual = create_document_vectorizer(settings=AllMiniLmDocumentVectorizerModelSettings())
...
def test_create_nomic_embed_text_document_vectorizer(mocker: MockerFixture) -> None:
    ...
    actual = create_document_vectorizer(settings=NomicEmbedTextDocumentVectorizerModelSettings())
