...
from oldv.document_vectorizers.nomic_embed_text import NomicEmbedTextVectorizer
...
def test_nomic_embed_text_vectorize() -> None:
    expected = nomic_embed_text_hello_world_vector
    sut = NomicEmbedTextVectorizer.create()
